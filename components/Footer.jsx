...
export function Footer() {
  return (
    <footer className="border-t border-gray-200 bg-[url('/images/footer.jpg')] bg-cover bg-center bg-no-repeat py-10">
      <StickyFooter />
      <Container>
        <div className="my-10 grid grid-cols-1 gap-4 pb-6 pt-16 md:grid-cols-4 md:py-6 lg:flex-row lg:items-center">
          ...
          <div>
            <p className="text-xs text-white">
              ตัวแทนจำหน่ายรถยนต์ใหม่ และมือสองที่ได้รับรางวัล เป็นของศูนย์กลางตลาดรถที่ดีที่สุด
              ซึ่งมีสาขา ทั่วประเทศไทย รับประกันราคาต่ำสุดและการบริการลูกค้าที่ดีที่สุด
            </p>
          </div>
          <div className="-mx-4 flex items-center p-4">
            ...
            <div className="ml-8 lg:w-64">
              ...
              <p className="mt-1 text-base text-gray-100">support@car2autobuy.com</p>
            </div>
          </div>
        </div>
        <div className="flex flex-col items-center border-t border-gray-200 pb-4 pt-8 md:flex-row md:justify-between md:pt-6">
          ...
          <p className="my-6 text-sm text-gray-100">
            &copy; Copyright {new Date().getFullYear()}. All rights reserved Car2autobuy
          </p>
