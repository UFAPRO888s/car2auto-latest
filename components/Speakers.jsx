...
const days = [
  {
    name: "เกร็ดความรู้เรื่องรถยนต์",
    date: "เรื่องรถยนต์น่ารู้",
    dateTime: "2022-04-06",
    responsible: "admin1",
    speakers: [
      {
        name: "ข้อมูลน่ารู้",
        role: "เรื่องรถยนต์น่ารู้",
        image: CarX1,
      ...
      },
      {
        ...
        role: "ข่าวTopPick",
        image: CarX2,
        href: "car-story/?cat=TopPick",
      },
      {
        name: "เปรียบเทียบ",
        role: "เปรียบเทียบ",
        image: CarX3,
        href: "car-story/?cat=เปรียบเทียบ",
      },
    ],
  },
  {
    name: "Car รีวิว",
    date: "แนะนำรีวิวรถยนต์",
    dateTime: "2022-04-04",
    responsible: "admin3",
    speakers: [
      {
    ...
    >
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2
            id="speakers-title"
            className="text-4xl font-medium tracking-tighter text-zinc-600 md:text-5xl"
          >
            บทความ ข่าวรถยนต์มือสอง
          </h2>
          <p className="mt-4 text-lg md:text-2xl tracking-tight text-zinc-900">
