...
export default function Terms() {
  return (
    <>
      ...
      <PageSEO
        title={'ข้อกำหนดและเงื่อนไข รถมือสอง ราคาคุ้มค่า รับประกันคุณภาพ - รถมือสอง car2autobuy'}
        description={
          'บริการ รถมือสอง car2autobuy ยอมรับและตกลงผูกพันตามข้อกำหนดและเงื่อนไขในการใช้บริการและการทำธุรกรรมทางอิเล็กทรอนิกส์ในรูปแบบต่าง ๆ'
        }
      />
      <Container>
        <div className="mt-10 overflow-hidden bg-slate-100 lg:bg-transparent lg:px-5 leading-relaxed">
          ...
          <div>
            <div className="prose max-w-none px-4 py-4">
              <h2 className="text-2xl font-bold">เงื่อนไขการใช้บริการ คาร์ทูออโต้บาย</h2>
              <p>
                ผู้ใช้บริการยอมรับและตกลงผูกพันตามข้อกำหนดและเงื่อนไขในการใช้บริการและการทำธุรกรรมทางอิเล็กทรอนิกส์ในรูปแบบต่าง
                ๆ กับบริษัท คาร์ทูออโต้บาย (ประเทศไทย) จำกัด ดังต่อไปนี้
              </p>
              <p>
                1. การติดต่อ การให้บริการ และการทำธุรกรรมทางอิเล็กทรอนิกส์ด้วยวิธีการใด ๆ เช่น
                การติดต่อสื่อสารผ่านการใช้อีเมลของบริษัทฯ การประกาศขายรถยนต์มือสองทางอินเตอร์เน็ต
                และการเปลี่ยนรหัส Email Address เป็นต้น เป็นบริการของบริษัทฯ
              ...
              <p>
                2. ในการติดต่อ การรับการให้บริการ และการทำธุรกรรมทางอิเล็กทรอนิกส์ตามข้อ 1.
                ผู้ใช้บริการจะรับผิดชอบในการเก็บรักษารหัสประจำตัวผู้ใช้ (User ID) รหัสผ่าน
                (Password) และรหัสประจำตัวส่วนบุคคล (Pin Code) (ถ้ามี) ของบัญชีของผู้ใช้บริการ
                รวมถึงรหัส Email Address หรือรหัสการติดต่ออื่นใด
                ซึ่งเป็นการระบุตัวตนของผู้ใช้บริการที่ใช้ในการติดต่อ การรับการให้บริการ
                และการทำธุรกรรมทางอิเล็กทรอนิกส์กับบริษัทฯ ไว้เป็นความลับ
              </p>
              <p>
                3. การติดต่อ การใช้บริการ และการทำธุรกรรมทางอิเล็กทรอนิกส์ใด ๆ
                ที่กระทำผ่านระบบอิเล็กทรอนิกส์ของบริษัทฯ โดยใช้รหัสประจำตัวของผู้ใช้บริการตามข้อ 2.
                ...
                โดยผู้ใช้บริการไม่จำต้องลงลายมือชื่อในเอกสารใด ๆ หรือกระทำการใด ๆ
                เพื่อเป็นหลักฐานในการกระทำนั้นอีก และผู้ใช้บริการตกลงว่า บริษัทฯ ไม่ต้องรับผิดใด ๆ
              ...
              <p>
                ...
                การไม่สามารถส่งข้อมูลได้ รวมถึงการผิดพลาดคลาดเคลื่อนของข้อมูลที่ได้รับ เป็นต้น
                ทั้งนี้ บริษัทฯ ไม่ต้องรับผิดชอบต่อความสูญเสียและ/หรือ ความเสียหายใด ๆ
              ...
              <div>
                ...
                <ul>
                  <li>
                    5.1. เนื้อหา – บริษัทฯไม่รับรองว่าเนื้อหาในเว็บไซต์ของบริษัทฯ จะมีความถูกต้อง
                    สมบูรณ์เพียงพอ และทันสมัยอยู่ตลอดเวลา แม้บริษัทฯ
                    จะทำการตรวจทานเนื้อหาดังกล่าวและความสอดคล้องของเนื้อหาอยู่เป็นประจำก็ตาม ดังนั้น
                    บริษัทฯ จึงไม่อาจรับผิดชอบ ไม่ว่าโดยตรงหรือโดยอ้อม สำหรับความผิดพลาด
                    และความล่าช้าของข้อมูล ไม่ว่าจะมีผู้ใดได้แจ้งหรือแนะนำบริษัทฯ
                    เกี่ยวกับโอกาสที่จะเกิดปัญหาดังกล่าวก่อนหน้านี้แล้วหรือไม่ก็ตาม
                  </li>
                  <li>
                    5.2. ความเสียหาย - หากเกิดความสูญเสียหรือความเสียหายใด ๆ
                    ขึ้นไม่ว่าโดยทางตรงหรือโดยทางอ้อม หรือเป็นผลสืบเนื่องจากการใช้บริการ เช่น
                    การเขียนและเผยแพร่ข้อความที่ต้องห้าม เป็นต้น บริษัทฯ
                    ไม่ต้องรับผิดชอบในความสูญเสียหรือความเสียหายดังกล่าวต่อผู้ใช้บริการ
                    และ/หรือบุคคลผู้ได้รับความสูญเสียและ/หรือ ความเสียหายดังกล่าว
                    ...
                    ที่เกิดขึ้นจากการใช้บริการนี้ทั้งสิ้น เว้นแต่ความสูญเสียและ/หรือ
                  ...
                  <li>
                    5.3. ระบบบริการ - ผู้ใช้บริการรับทราบและตกลงอย่างชัดแจ้งว่า บริษัทฯ ไม่รับรองว่า
                    การเปิดเข้าสู่หรือการใช้เว็บไซต์ทั้งส่วนหนึ่งส่วนใดหรือทั้งหมดจะสามารถกระทำได้ตลอดเวลา
                    รวดเร็วทันใจ ปราศจากการรบกวนหรือข้อผิดพลาด และไม่รับรองว่าเว็บไซต์จะปราศจากไวรัส
                    ระเบิดเวลา
                  ...
                  <li>
                    ...
                    <p>
                      5.4.1. ถูกต้องสมบูรณ์ ไม่บกพร่อง หรือสมตามความประสงค์ของผู้ใช้บริการ
                  ...
                  <li>
                    ...
                    หากการบริการก่อให้เกิดความเสียหายแก่ผู้ใช้บริการหรือบุคคลใด ๆ ก็ตาม บริษัทฯ
                    ไม่มีหน้าที่ต้องรับผิดชอบทั้งสิ้น
                    เว้นแต่ความเสียหายดังกล่าวจะเกิดขึ้นจากการกระทำโดยทุจริตหรือความประมาทเลินเล่ออย่างร้ายแรงของบริษัทฯ
                  </li>
                </ul>
              </div>
              <p>
                6. บริษัทฯ เป็นเจ้าของลิขสิทธิ์ในบรรดาข้อความ ภาพ เสียง เนื้อหา ส่วนประกอบใด ๆ
                ทั้งหมดของบริการ รวมถึงแต่ไม่จำกัดเพียงเครื่องหมายทางการค้า เครื่องหมายบริการ ชื่อ
                ชื่อทางการค้า สิทธิบัตร โนว์ฮาว (Know-how) และทรัพย์สินทางปัญญาอื่นใดของบริการ
                ที่ปรากฏในทุก ๆ หน้าของเว็บไซต์ ห้ามมิให้ผู้ใดหรือบริษัทฯ ใด ทำซ้ำ ดัดแปลง
                จัดเก็บในระบบที่สามารถนำมาใช้งานได้ ถ่ายโอน ลอกเลียนแบบ เผยแพร่ หรือ
                ใช้ข้อมูลส่วนใดส่วนหนึ่งของข้อมูลดังกล่าว
                โดยมิได้รับความยินยอมเป็นลายลักษณ์อักษรจากบริษัทฯ ทั้งนี้ บริษัทฯ
              ...
              <p>
                ...
                และระงับบริการไว้ชั่วคราวหรือถาวรได้ตลอดเวลา โดยไม่ต้องบอกกล่าวให้ทราบล่วงหน้า
              ...
              <p>
                ...
                เชื่อมโยงและนำข้อมูลที่ผู้ใช้บริการเป็นเจ้าของและปรากฏในเว็บไซต์ใด ๆ เช่น
                บรรดาข้อความ ภาพ เสียง เนื้อหา หรือ ส่วนประกอบใด ๆ มาปรากฎในเว็บไซต์ของบริษัทฯ
                โดยไม่จำต้องแจ้งความประสงค์ให้ทางเว็บไซต์ต้นทางทราบถึงหรือให้ความยินยอมแก่การกระทำนี้ล่วงหน้า
                และบริษัทฯ จะไม่รับผิดชอบต่อความเสียหายใด ๆ อันเกิดจากการกระทำดังกล่าว อย่างไรก็ตาม
                ผู้ใช้บริการยังคงมีสิทธิโดยชอบธรรมต่อข้อมูลดังกล่าวที่ผู้ใช้บริการเป็นเจ้าของ
                ทั้งนี้ หากผู้ใช้บริการไม่ต้องการให้บริษัทฯ
                เชื่อมโยงและนำข้อมูลดังกล่าวมาปรากฏในเว็บไซต์ของบริษัทฯ ผู้ใช้บริการจะแจ้งให้บริษัทฯ
                ทราบเป็นลายลักษณ์อักษร โดยทางบริษัทฯ มีสิทธิที่จะพิจารณาเรื่องดังกล่าวตามความเหมาะสม
              </p>
              <p>
                11. ข้อกำหนดและเงื่อนไขในการลงทะเบียนขายรถยนต์ ในการลงทะเบียนขายรถยนต์
              ...
              <p>
                ...
                และข้อมูลของรถยนต์ให้กับผู้ซื้อที่ทางบริษัทฯ จัดหามาให้ ในการลงทะเบียนขายรถยนต์
                ...
                รวมทั้งรถยนต์จดประกอบ รถอินวอยส์ รถสรรพสามิต (ที่ไม่มีหนังสือรับรอง)
                รวมไปถึงรถยนต์ที่นำเข้ามาอย่างไม่ถูกต้องตามกฎหมาย เอกสารไม่ครบ
                หรือรถหลุดจำนำที่ไม่มีสมุดทะเบียนที่ออกโดยกรมการขนส่งทางบก หากบริษัทฯ
                พบหรือมีเหตุอันควรเชื่อว่าผู้ใช้บริการฝ่าฝืนข้อกำหนดและเงื่อนไขต่าง ๆ ข้อใดข้อหนึ่ง
                บริษัทขอสงวนสิทธิ์ในการลบประกาศ ระงับการแสดงประกาศ หรือแก้ไขเปลี่ยนแปลงประกาศ
                ซึ่งถือเป็นสิทธิ์ขาดและขึ้นอยู่กับดุลพินิจของบริษัท
                โดยไม่ต้องบอกกล่าวให้ผู้ขายทราบล่วงหน้า ข้อกำหนดและเงื่อนไขฉบับนี้
                บริษัทขอสงวนสิทธิ์ในการยกเลิก หรือเปลี่ยนแปลงรายละเอียดโดยมิต้องแจ้งให้ทราบล่วงหน้า
                การเปลี่ยนแปลง หรือเพิ่มเติม ข้อกำหนดและเงื่อนไขใด ๆ
                ให้ถือเป็นส่วนหนึ่งของข้อกำหนดและเงื่อนไขนี้ และมีผลบังคับโดยทันที
                การที่ผู้ขายยินยอมลงทะเบียนขายรถยนต์กับทางบริษัท หรือการใช้บริการในเว็บไซต์ และ/หรือ
              ...
              <div>
                ...
                บริษัทจะดำเนินการตามวิธีการที่เหมาะสมหลังจากที่ได้รับข้อมูลจากลูกค้า (ข้อมูลลูกค้า
                เช่น ชื่อ-นามสกุล ,เบอร์โทร ,ข้อมูลรถ ฯลฯ )
                บริษัทจะไม่ใช้ข้อมูลส่วนบุคคลเพื่อวัตถุประสงค์อื่นๆ
                นอกเหนือจากที่ลูกค้าได้ตกลงยอมรับไว้ก่อนหน้า (ไม่รวมถึงตามกฎหมายกำหนด)
                ...
                <ul>
                  <li>12.1. เพื่อให้ข้อมูลเกี่ยวกับการซื้อขายและแคมเปญต่างๆ กับลูกค้าทางออนไลน์</li>
                  <li>12.2. เพื่อยืนยันการซื้อขายผลิตภัณฑ์ </li>
                  <li>12.3. เพื่อสอบถามลูกค้าให้ตอบคำถามต่อผลิตภัณฑ์และบริการของบริษัท </li>
                  <li>12.4. เพื่อขอความเห็นของลูกค้าในการปรับปรุงผลิตภัณฑ์และบริการของบริษัท</li>
                  <li>
              ...
              <p>
                ...
                โดยการเปลี่ยนการตั้งค่าคุกกี้ด้วยตัวเอง ลูกค้าสามารถบล็อกคุกกี้ได้ ทั้งนี้
                หากมีการบล็อคคุกกี้ ผู้ใช้อาจไม่สามารถใช้บริการบางอย่างในเว็บไซต์นั้นได้ นอกจากนี้
                ขึ้นอยู่กับการใช้สภาพแวดล้อมในการใช้งานของลูกค้า (การตั้งค่าเบราว์เซอร์
                การเชื่อมต่ออินเตอร์เน็ต) อาจจะไม่สามารถบล็อคคุกกี้ได้ในบางกรณี
              </p>
              <p>
                15. กรณีที่ลูกค้าลงข้อมูลรถเพื่อขายรถแบบด่วนบนเว็บไซต์คาร์ทูออโต้บาย
                และไม่สามารถจบการขายได้ภายใน 30 วัน นับตั้งแต่วันที่ลงข้อมูลรถครั้งแรก
                ข้อมูลรถของคุณจะขึ้นไปอยู่ในหน้าประกาศขายรถของ คาร์ทูออโต้บาย ตลาดรถ
                โดยอัตโนมัติทันที ซึ่งในระหว่าง 30 วันก่อนการประกาศขายในหน้า คาร์ทูออโต้บาย ตลาดรถ
                คุณสามารถเข้าไปแก้ไขข้อมูลรถได้ และหลังจากข้อมูลรถได้ลงประกาศขายในหน้า
                คาร์ทูออโต้บาย ตลาดรถ คุณจะสามารถเข้าไปแก้ไข หรือลบข้อมูลรถได้
                โดยเข้าสู่ระบบด้วยเบอร์โทรศัพท์ที่ลงทะเบียนเท่านั้น
              </p>
              <p>
                16. กรณีที่ลูกค้าทั่วไปลงข้อมูลรถเพื่อขายรถเป็นครั้งแรก
                และยินยอมให้ข้อมูลรถของลูกค้าขายผ่านช่องทาง CAR2AUTOBUY Express และ CAR2AUTOBUY
                SellCar บนเว็บไซต์คาร์ทูออโต้บายทันที ในช่วง 5 วันแรก ชื่อ-นามสกุล และเบอร์ติดต่อ
                จะเป็นชื่อในนามบริษัท CAR2AUTOBUY เพื่อให้ CAR2AUTOBUY
                ช่วยขายรถของคุณให้จบแบบด่วนที่สุด แต่ถ้าทางคาร์ทูออโต้บายไม่สามารถจบการขายได้ภายใน 5
                วัน ชื่อ-นามสกุล และเบอร์ติดต่อ จะเปลี่ยนเป็นชื่อลูกค้าโดยอัตโนมัติ
