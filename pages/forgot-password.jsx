...
const ForgotPasswordPage = () => {
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      setSuccessMessage("ส่งอีเมลรีเซ็ตรหัสผ่านสำเร็จแล้ว");
    } catch (error) {
      console.log(error.message);
      setErrorMessage("เกิดข้อผิดพลาดขณะส่งอีเมลรีเซ็ตรหัสผ่าน");
    }
  };

  return (
    <div className="container mx-auto max-w-md mt-8">
      <h2 className="text-2xl font-semibold text-blue-900 mb-4">ลืมรหัสผ่าน</h2>
      {successMessage && (
        <div
