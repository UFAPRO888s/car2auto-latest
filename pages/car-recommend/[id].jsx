...
const CarRecommendPost = (props) => {
  ...
  return (
    <>
      ...
      <Container>
        <div className="grid grid-cols-1 gap-y-16 py-20 lg:grid-cols-4 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="col-span-3 lg:order-first lg:row-span-2">
            <div>
...
export async function getServerSideProps(context) {
  ...
  const res = await fetch(
    `https://www.carsome.co.th/news/wp-json/wp/v2/posts?_embed&slug=${encodeURI(
      id
    )}`
  )
...
export default CarRecommendPost
